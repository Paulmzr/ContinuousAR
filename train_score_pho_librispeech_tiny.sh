...
EXP_NAME=librispeech.score.pho.normalize.tiny.12+12_layers.bsz_64

OUTPUT_DIR=./experiments/${EXP_NAME}
mkdir -p $OUTPUT_DIR
LOG_FILE=./experiments/${EXP_NAME}/log

torchrun --nproc_per_node 2 --nnodes 1 --master_port 29501 scripts/train_score_librispeech_pho.py \
